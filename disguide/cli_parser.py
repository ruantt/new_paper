...
def _add_generic_args(parser):
    ...
    # Informativeness / selector configs
    parser.add_argument('--use-boundary-sampling', action='store_true', default=False)
    parser.add_argument('--boundary-sample-ratio', type=float, default=None)
    parser.add_argument('--use-mc-uncertainty', action='store_true', default=False)
    parser.add_argument('--mc-samples', type=int, default=5)
    parser.add_argument('--mc-threshold', type=float, default=None)
    parser.add_argument('--selector-percentiles', nargs='+', type=float, default=[0.5, 0.9])

    parser.add_argument('--use-informativeness-prior', action='store_true', default=False)
    parser.add_argument('--informativeness-weight', type=float, default=0.0)
    parser.add_argument('--informativeness-schedule', type=str, default='none', choices=['none', 'linear'])
    parser.add_argument('--informativeness-warmup', type=int, default=1)
    parser.add_argument('--informativeness-objective', type=str, default='mean', choices=['mean', 'topk_mean'])
    parser.add_argument('--informativeness-topk-ratio', type=float, default=None)
    parser.add_argument('--informativeness-combine-strategy', type=str, default='weighted_sum',
                        choices=['weighted_sum', 'gate_then_rank'])
    parser.add_argument('--informativeness-weight-epistemic', type=float, default=None)
    parser.add_argument('--informativeness-weight-boundary', type=float, default=None)
    parser.add_argument('--informativeness-gate-quantile', type=float, default=None)
    parser.add_argument('--informativeness-boundary-topk', type=float, default=None)
    parser.add_argument('--informativeness-differentiable', action='store_true', default=False)
